...
namespace SimpleUrlShorten
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDBContext>(options => options.UseSqlServer(Configuration["Data:UrlStore:ConnectionString"]));
            services.AddTransient<UrlRepository>();

            // Adds services required for using options.
            services.AddOptions();

            // custome services for DI
